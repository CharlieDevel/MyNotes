...
' This should be inserted as a macro in the worksheet you want to filter, you do this by pressing Alt + f11 > Insert > Module, and paste all in here, to activate the macro, you can press Alt + f8, and select the 'FilterQueryTable' macro
' After you run the macro and filtered, and you want to bring back the data filtered, you can click the 'Data' tab, and click the 'button with an icon of the filter' twice, which will deactivate and reactivate filters applied on the current table
